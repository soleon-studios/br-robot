...
const CharacterPicker = () => {
  const { handleRobotChange } = useRobotContext();

  return (
    <div className='character-container'>
      <h3>Choose your Robot</h3>
      <div className='characters'>
        <div onClick={() => handleRobotChange('Bellroy-Owl')}>
          <svg
            className='robot-svg'
            style={{
              fill: '#e15a1d',
        ...
        <div onClick={() => handleRobotChange('Transit-Backpack')}>
          <img
            alt='transit-backpack-robot'
            height='100'
            src='https://bellroy-product-images.imgix.net/bellroy_dot_com_gallery_image/AUD/BTBA-BLK-204/0?auto=format&amp;fit=max&amp;w=750'
            title=''
            style={{
              borderRadius: '5px',
            }}
        ...
        <div onClick={() => handleRobotChange('Pixel-Case')}>
          <img
            alt='transit-backpack-robot'
            height='100'
            src='https://bellroy-product-images.imgix.net/bellroy_dot_com_gallery_image/AUD/WTFB-CAR-301/0?auto=format&amp;fit=max&amp;w=750'
            title=''
            style={{
              borderRadius: '5px',
            }}
        ...
        <div onClick={() => handleRobotChange('Travel-Folio')}>
          <img
            alt='transit-backpack-robot'
            height='100'
            src='https://bellroy-product-images.imgix.net/bellroy_dot_com_gallery_image/AUD/PCFH-STU-134/0?auto=format&amp;fit=max&amp;w=750'
            title=''
            style={{
              borderRadius: '5px',
            }}
